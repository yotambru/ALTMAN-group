    ...
    <main className="app-shell flex min-h-[100dvh] flex-col bg-surface px-5 pb-10 pt-[max(1.25rem,env(safe-area-inset-top))]">
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-text">
        ...
        <section className="space-y-2">
          ...
          <p>
            ניתן להתנתק מהמערכת בכל עת. מחיקת חשבון מתבצעת על ידי מנהל המערכת
            בלבד, ולא מתוך פרופיל המשתמש. המחיקה מסירה לצמיתות את חשבון הכניסה
            ואת הנתונים האישיים מהשרת, ולא ניתן לשחזר אותם. בקשות נוספות ניתן
            להפנות אל{" "}
            <a
