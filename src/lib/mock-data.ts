...
export const properties: Property[] = [
  {
    ...
    bathrooms: 2,
    status: "rented",
    /** Implied market value: annual rent ÷ 2.8% portfolio yield. */
    value: 2785714,
    municipalTax: 640,
    ...
    waterMeter: "21830419",
    gasMeter: "704218",
    managementCompanyPhone: "03-5241180",
    imageId: "tower",
    landlordId: "l_1",
    tenantId: "t_1",
  },
  {
    ...
    waterMeter: "33190267",
    gasMeter: "812045",
    managementCompanyPhone: "03-5612290",
    imageId: "residential",
    landlordId: "l_1",
    tenantId: "t_2",
  },
  {
    ...
    waterMeter: "44011832",
    gasMeter: "629173",
    managementCompanyPhone: "03-6094412",
    imageId: "garden",
    landlordId: "l_1",
  },
  {
    ...
    waterMeter: "55207641",
    gasMeter: "918360",
    managementCompanyPhone: "03-7183301",
    imageId: "boutique",
    landlordId: "l_2",
  },
  {
    ...
    waterMeter: "20817463",
    gasMeter: "917452",
    managementCompanyPhone: "03-5248806",
    imageId: "residential",
    landlordId: "l_3",
    tenantId: "t_5",
  },
...
export const tenants: Tenant[] = [
  ...
  { id: "t_6", fullName: "עומר שדה", phone: "052-6677889", email: "omer@example.com", propertyId: "p_2", leaseId: "ls_6", idNumber: "306677889", idPhotoUploaded: true },
];

export const leases: Lease[] = [
  {
    id: "ls_1", propertyId: "p_1", tenantId: "t_1", landlordId: "l_1", monthlyRent: 6500,
    startingMonthlyRent: 6200,
    rentAdjustments: [{ date: "2025-10-15", monthlyRent: 6500 }],
  ...
  },
  {
    ...
    startingMonthlyRent: 5500,
    rentAdjustments: [{ date: "2025-09-20", monthlyRent: 5800 }],
  ...
  {
    id: "ls_6", propertyId: "p_2", tenantId: "t_6", landlordId: "l_1", monthlyRent: 5400,
    startDate: "2022-08-01", endDate: "2024-08-31", nextPaymentDate: "2024-08-05", active: false,
    managementStartDate: "2022-08-01", managementEndDate: "2024-08-31",
    managementFeePercent: 8, managementFeeBeforeVat: 432, managementFeeIncVat: 505,
  },
];
...
export const documents: AppDocument[] = [
  { id: "doc_1", name: "חוזה שכירות — דיזנגוף 123", type: "contract", folder: "lease", propertyId: "p_5", landlordId: "l_3", tenantId: "t_5", createdAt: "2026-07-20T00:00:00.000Z", signed: true, status: "signed", ownerUserId: "u_tenant", signedByName: "דני שמעוני", signedAt: "2026-07-20T10:00:00.000Z" },
  { id: "doc_2", name: "אישור תשלום ארנונה", type: "approval", folder: "appendices", propertyId: "p_5", landlordId: "l_3", tenantId: "t_5", createdAt: "2026-07-22T00:00:00.000Z", signed: false, status: "draft" },
  { id: "doc_3", name: "דוח שנתי 2025", type: "report", folder: "appendices", landlordId: "l_1", createdAt: "2026-01-15T00:00:00.000Z", signed: false, status: "draft", ownerUserId: "u_landlord" },
  { id: "doc_4", name: "נספח חידוש חוזה — תשי\u05F4לר 78", type: "contract", folder: "lease_renewal", propertyId: "p_1", landlordId: "l_1", tenantId: "t_1", createdAt: "2026-07-25T00:00:00.000Z", signed: false, status: "awaiting_signature", ownerUserId: "u_landlord" },
  { id: "doc_5", name: "חוזה שכירות — תשי\u05F4לר 78", type: "contract", folder: "lease", propertyId: "p_1", landlordId: "l_1", tenantId: "t_1", createdAt: "2024-10-15T00:00:00.000Z", signed: true, status: "signed", ownerUserId: "u_landlord", signedByName: "דניאל כהן", signedAt: "2024-10-15T12:00:00.000Z" },
  { id: "doc_6", name: "פוליסת ביטוח מבנה — תשי\u05F4לר 78", type: "insurance", folder: "appendices", propertyId: "p_1", landlordId: "l_1", tenantId: "t_1", createdAt: "2025-09-01T00:00:00.000Z", signed: false, status: "draft", ownerUserId: "u_landlord" },
  { id: "doc_7", name: "חוזה שכירות — הארבעה 12", type: "contract", folder: "lease", propertyId: "p_2", landlordId: "l_1", tenantId: "t_2", createdAt: "2024-09-20T00:00:00.000Z", signed: true, status: "signed", ownerUserId: "u_landlord", signedByName: "דניאל כהן", signedAt: "2024-09-20T11:00:00.000Z" },
  { id: "doc_8", name: "אישור ועד בית — הארבעה 12", type: "approval", folder: "appendices", propertyId: "p_2", landlordId: "l_1", tenantId: "t_2", createdAt: "2026-03-10T00:00:00.000Z", signed: false, status: "draft", ownerUserId: "u_landlord" },
  { id: "doc_9", name: "טופס מסירה — דרך השלום 54", type: "protocol", folder: "entry_protocol", propertyId: "p_3", landlordId: "l_1", tenantId: "t_3", createdAt: "2026-06-01T00:00:00.000Z", signed: false, status: "draft", ownerUserId: "u_landlord" },
  { id: "doc_10", name: "מסמך רשות מקומית — ארנונה", type: "approval", folder: "appendices", propertyId: "p_2", landlordId: "l_1", tenantId: "t_2", createdAt: "2026-04-10T00:00:00.000Z", signed: false, status: "draft", ownerUserId: "u_landlord" },
  { id: "doc_11", name: "צילום ת״ז — יוסי לוי", type: "id", folder: "id_photos", propertyId: "p_1", landlordId: "l_1", tenantId: "t_1", createdAt: "2024-10-14T00:00:00.000Z", signed: false, status: "draft" },
  { id: "doc_12", name: "צילום ת״ז ערב — תשי\u05F4לר 78", type: "id", folder: "guarantor_id", propertyId: "p_1", landlordId: "l_1", tenantId: "t_1", createdAt: "2024-10-14T00:00:00.000Z", signed: false, status: "draft" },
  { id: "doc_13", name: "צילום מונה חשמל — הארבעה 12", type: "id", folder: "meter_photos", propertyId: "p_2", landlordId: "l_1", tenantId: "t_2", createdAt: "2024-09-20T00:00:00.000Z", signed: false, status: "draft" },
  { id: "doc_14", name: "חוזה שכירות — עומר שדה", type: "contract", folder: "lease", propertyId: "p_2", landlordId: "l_1", tenantId: "t_6", createdAt: "2022-08-01T00:00:00.000Z", signed: true, status: "signed", signedByName: "דניאל כהן", signedAt: "2022-08-01T12:00:00.000Z" },
  { id: "doc_15", name: "צילום ת״ז — עומר שדה", type: "id", folder: "id_photos", propertyId: "p_2", landlordId: "l_1", tenantId: "t_6", createdAt: "2022-07-28T00:00:00.000Z", signed: false, status: "draft" },
];
