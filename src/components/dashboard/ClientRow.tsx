...
import { Building2, ChevronLeft, Phone, Search, Trash2 } from "lucide-react";
...
export function ClientRow({ landlord, propertyCount, subtitle, avatarUrl, onClick, onDelete }: ClientRowProps) {
  return (
    <div className="flex items-center gap-0.5">
      ...
      {onDelete && (
        <button
          type="button"
          aria-label={`מחיקת ${landlord.fullName}`}
          onClick={onDelete}
